CREATE OR REPLACE FUNCTION validate_ensemble_members()
    RETURNS TRIGGER AS $$
DECLARE
...
-- 트리거 생성
CREATE TRIGGER tr_validate_ensemble_members
    BEFORE INSERT ON ensemble_members
    FOR EACH ROW EXECUTE FUNCTION validate_ensemble_members();
